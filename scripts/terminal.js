...
const SCENARIOS = {
  ...
  configure: [
    { type: 'prompt', text: '$ ', delay: 300 },
    { type: 'command', text: '/connect-configure', delay: 600 },
    { type: 'banner', text: BANNER, delay: 200, instant: true },
    { type: 'dim', text: '/connect-configure | Use /connect-help to see all commands', delay: 400 },
    { type: 'output', text: '', delay: 200 },
    { type: 'output', text: 'Reading .connect-wizard-config.json...', delay: 600 },
    { type: 'success', text: '  Current: Express \u00b7 destination charges \u00b7 10% fee', delay: 300 },
    { type: 'output', text: '', delay: 300 },
    { type: 'question', text: 'What would you like to change?', delay: 300 },
    { type: 'output', text: '', delay: 100 },
    { type: 'option', text: '  1. Platform fee percentage', delay: 80 },
    { type: 'option', text: '  2. Charge pattern', delay: 80 },
    { type: 'option', text: '  3. Payout timing', delay: 80 },
    { type: 'option', text: '  4. Account capabilities', delay: 80 },
    { type: 'output', text: '', delay: 600 },
    { type: 'input', text: '> 1', delay: 500 },
    { type: 'output', text: '', delay: 400 },
    { type: 'question', text: 'New platform fee? (current: 10%)', delay: 300 },
    { type: 'output', text: '', delay: 400 },
    { type: 'input', text: '> 15', delay: 500 },
    { type: 'output', text: '', delay: 400 },
    { type: 'output', text: 'Applying changes...', delay: 600 },
    { type: 'output', text: '', delay: 200 },
    { type: 'heading', text: 'Diff: server/routes/payments.js', delay: 200 },
    { type: 'dim', text: '  - application_fee_amount: Math.round(amount * 0.10),', delay: 150 },
    { type: 'success', text: '  + application_fee_amount: Math.round(amount * 0.15),', delay: 150 },
    { type: 'output', text: '', delay: 200 },
    { type: 'heading', text: 'Diff: .connect-wizard-config.json', delay: 200 },
    { type: 'dim', text: '  - "platformFeePercent": 10,', delay: 150 },
    { type: 'success', text: '  + "platformFeePercent": 15,', delay: 150 },
    { type: 'output', text: '', delay: 400 },
    { type: 'success', text: 'Done! Platform fee updated: 10% \u2192 15%', delay: 200 },
    { type: 'dim', text: 'Run /connect-test to verify the new fee split', delay: 200 },
  ],
};
